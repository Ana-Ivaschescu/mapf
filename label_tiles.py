...
directory_path = r'C:\mapformer\data/HRSCD/labels/'
...
for year in ['2006', '2012']:
    for d in ['D14', 'D35']:
        ...
        for file in tqdm(files):
            ...
            os.makedirs(osp.join(out_dir, 'labels', year, d, name), exist_ok=True)
            output_folder = osp.join(out_dir, 'labels', year, d, name)
