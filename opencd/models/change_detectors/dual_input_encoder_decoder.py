...
from mmseg.models.ccd.encoder_decoder import split_into_tiles, merge_tiles
...
class DIEncoderDecoder(BaseSegmentor):
    ...
    def __init__(self,
                 ...
                 inference_tile_size=None):
        assert init_cfg is None # remove init_cfg from super-constructor for backward compatibility
        super(DIEncoderDecoder, self).__init__()
    ...
    def _init_decode_head(self, decode_head):
        ...
        self.out_channels = self.decode_head.channels # modified by me
    ...
    def simple_test(self, img, img_meta, rescale=True):
        ...
        assert seg_pred.shape[0] == 1, 'Inference should be run with a batch size of one!'
        bc = seg_pred[0]
        sem = np.zeros_like(bc)
